package io.github.kornercraft.pleaguemanager.gui.impl;

import io.github.kornercraft.pleaguemanager.configs.Lang;
import io.github.kornercraft.pleaguemanager.gui.InventoryButton;
import io.github.kornercraft.pleaguemanager.gui.InventoryGUI;
...
public class PerRosterGUI extends InventoryGUI {
    ...
    private boolean hasAccess(Player player) {
        return getHelper().playerInGroup(player.getUniqueId(), "kcfa") || getHelper().playerInGroup(player.getUniqueId(), "owner") || getHelper().playerInGroup(player.getUniqueId(), "helper") || getHelper().playerInGroup(player.getUniqueId(), "mod") || getHelper().playerInGroup(player.getUniqueId(), "admin");
    }
