...
public class MigrateCommand extends BaseCommand {
  ...
  public void onMigrate(CommandSender sender, String[] args) {
    if (args.length < 1) {
      ...
      getLogger().send("kcfa", Lang.MIGRATED_NOTIFY.getConfigValue(new String[]{sender.getName(), oldNick}));
      ...
      getLogger().send("kcfa", Lang.MIGRATED_OTHER.getConfigValue(new String[]{sender.getName(), target.getName(), oldNick}));
